...
PlatformerEntityBaseDraggable {
    ...
    fixture.onBeginContact: {
      ...
      // on contact with a star, collect it and make player invincible
        ...
        startInvincibility(starInvincibilityTime)
           ...
           console.debug("active is " + otherEntity.isActive + " image.visible is " + otherEntity.image.visible + " collected is " + otherEntity.collected + " isBlockContactFlower " + otherEntity.blockContactFlower + " isResetPosition " + otherEntity.isResetPosition)
        ...
        if(otherEntity.collected)
        {
            startInvincibility(starInvincibilityTime)
                ...
                if (playerHighestY > blockJumpLowestY && otherEntity.isResetPosition) {
                    console.debug(
  ...
  BoxCollider {
    ...
    fixture.onBeginContact: {
      ...
      else if(otherEntity.entityType === "platform" || otherEntity.entityType === "ground" || otherEntity.entityType === "blockJumpOnly") {
    ...
    fixture.onEndContact: {
      ...
      if(otherEntity.entityType === "platform" || otherEntity.entityType === "ground" || otherEntity.entityType === "blockJumpOnly")
        contacts--
    }
  }
